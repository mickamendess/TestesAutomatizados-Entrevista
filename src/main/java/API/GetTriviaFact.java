...
public class GetTriviaFact {
	@Test
	public void Get() throws Throwable{
		System.out.println("Consumindo GetTriviaFact!");
		String url = ("https://numbersapi.p.rapidapi.com/42/trivia?json=true&notfound=floor&fragment=true");	
